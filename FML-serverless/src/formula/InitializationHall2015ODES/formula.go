package InitializationHall2015ODES
...
func Calculate(gender Gender.Enum, age int64, heightCMS, pal, rmr, initialFMkg, initialBWkg, propC, propF, propP, prop_pi, NewC, NewF, NewP, psi, extraExCal float64) (Result, error) {
