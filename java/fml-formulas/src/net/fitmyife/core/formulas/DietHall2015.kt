...
import net.fitmyife.core.formulas.exceptions.FormulaException
    ...
    fun run(input: DietHall205Input): DietHall205Result {
        ...
        while (Math.abs(errorFactor) > 50) {
            ...
            if ((averageEI_UP - averageEI_LOW) < 1) {
                throw FormulaException("There was an issue processing your weight data. Showing results based on your most recent verified entry")
            }
        }
